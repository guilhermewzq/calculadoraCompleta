...
function receberQuantidadePessoas(evento){
    const paragrafoErro = document.querySelector(".pessoas #erro") // Seleciona o elemento corretamente
...
function calcular(){
    if(conta !== 0 && porcentagem !== 0 && pessoas !== 0){
        const strongGorjetaTotal = document.querySelector(".gorjetaTotal > strong")
...
function limpar(){
    ...
    document.querySelector(".gorjetaTotal > strong").innerHTML = "R$ 0.00" 
